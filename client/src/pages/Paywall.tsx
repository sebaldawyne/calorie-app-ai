    ...
    <div className="min-h-screen bg-background flex flex-col p-6 animate-in fade-in duration-500">
      ...
      <div className="flex-1 flex flex-col items-center justify-center space-y-10">
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-amber-100 text-amber-700 rounded-full text-xs font-black uppercase tracking-widest mb-2">
            <Crown className="w-3.5 h-3.5" /> Pro Access
          </div>
          <h1 className="text-4xl font-black tracking-tight leading-none">Elevate Your Journey</h1>
        ...
        <Card className="w-full max-w-sm p-8 bg-card border-none shadow-2xl rounded-[2.5rem] relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4">
            <Badge className="bg-primary/10 text-primary border-none font-black px-3 py-1">BEST VALUE</Badge>
          </div>
          <div className="space-y-6 relative z-10">
            ...
            <Button onClick={handleSubscribe} className="w-full h-14 text-lg font-black rounded-2xl shadow-xl shadow-primary/30 group-hover:scale-[1.02] transition-transform">
